...
- 2003 Google released a [paper](https://research.google/pubs/pub51/) about their Google File System (GFS) (Storage)
--

- 2004 Google released a [paper](https://research.google/pubs/pub62/) about processing data on large cluster (MapReduce)
--

- 2006 first release of Hadoop 0.1.0. Open source implementation of GFS and MapReduce
--

- 2011 released of Hadoop 1.0.0 (HDFS+MapReduce)
--

- 2013 released of Hadoop 2.2.0 (first sable version of 2.x) (added a resource management layer)
--

- 2017 released of Hadoop 3.0.0
- 2021 released of Hadoop 3.2.2 (still an active project)
...
- The client request the selected DataNodes and marge back the file
...
- There are framework to process the data like  **MapReduce** or **Spark**
