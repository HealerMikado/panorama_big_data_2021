...
- is inherenly relative to _**who**_ is using it
...
<small>It is inherenly relative to **who** and is using it. What is a common software for someone may not be for someone else. For instance, relational databases for someone used to use spreadsheet software.</small>
...
To this day, can be considered "big" for a statistician :
...
To this day, **any data change is challenging** for a statistician :
...
- any non-standard format is a challenge (ex: annotated texts, vocal message conversations, etc.)

What is usually **not** an issue:

- storing network data (e.g. social graphs)
- storing formatted text such as XML, JSON, HTML, etc.
- storing raw, unformatted text
