...
.footnote[*Source : [Alibabacloud](https://www.alibabacloud.com/fr/knowledge/what-is-edge-computing)*]
]
...
**Normal storage** is the place where you put all of your files, script, logs, data or else: **anything that is worth saving.**

"Normal", in "normal storage" means:
- slower access than directly from the virtual machine
- faster than recovery storage

Normal storage is organised into units often called "buckets".
...
- disks that can be "attached" to and "detached" from a virtual machine (faster, but more expensive)
...
An already package platforme. Just need some tuning.
...
**Exemples :** Hadoop Platform (AWS EMR, GCP Cloud Dataproc, Azure HDInsight)
...
**Exemples :** Gmail, Github, Binder... (most the services you use as an individual)
