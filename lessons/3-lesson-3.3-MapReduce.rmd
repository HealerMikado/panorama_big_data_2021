...
- **Application Manager** (1 by task) : orchestrate all tasks relate to se same application
...
Records from the data source (line of a file, row of a DB, documents). Examples :
